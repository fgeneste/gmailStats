...
import StatUpdateComponent from '@/entities/stat/stat-update.vue';
import StatClass from '@/entities/stat/stat-update.component';
...
describe('Component Tests', () => {
  describe('Stat Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<StatClass>(StatUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.stat = entity;
        statServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(statServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.stat = entity;
        statServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(statServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        statServiceStub.retrieve.resolves([foundStat]);
